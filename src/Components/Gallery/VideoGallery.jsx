...
function VideoGallery() {
  ...
  const navigateToYoutube = (event, videoId) => {
    ...
    <>
      ...
      <div className="VideoContainer">
        <div className="buttonTab">
          ...
          <button onClick={() => filteritem("Artificial Intelligence")}>
            Artificial Intelligence
          </button>
          <button onClick={() => filteritem("Data Science")}>
            Data Science
          </button>
          <button onClick={() => filteritem("Android")}>Android</button>
          <button onClick={() => filteritem("Ethical Hacking")}>
            Ethical Hacking
          </button>
          <button onClick={() => filteritem("Website Design")}>
            Website Design
          </button>
          <button onClick={() => filteritem("Website Dev")}>
            Website Development
          </button>
        </div>
        <div className="videoGallery">
          {Items.map((element) => {
            const { id, image, title, description, category, videoId } = element;

            return (
              <div className="videoCard" key={id}  onClick={(event) => navigateToYoutube(event, videoId)}>
                <div>
